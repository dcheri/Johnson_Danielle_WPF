...
var jacksBehavior = prompt("Did Jack behave in school today? \(Please answer yes or no\)"); //Defines ja
var jillsBehavior = prompt("Did Jill behave in school today? \(Please answer yes or no\)");
...
if(jacksBehavior === "yes" && jillsBehavior === "yes"){
